...
- **Translations:** 17 new locales (ar, az, de, es, fa, fr, hi, it, ja, nl, pl, pt, ru, tr, uk, uz, zh_CN). (#110)

Thanks to @Elvin-Qulizade (Elvin Qulizada) for the i18n initiative behind these translations — first contributed in jeffersongoncalves/filament-scanner-guard#2 and now rolled out across the Filament plugins. He is credited as co-author.

### What's Changed

* ci: standardize tests workflow (2.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-help-desk/pull/107
* build(deps-dev): bump the npm-deps group with 5 updates by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-help-desk/pull/105
* feat(i18n): add translations (2.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-help-desk/pull/110

**Full Changelog**: https://github.com/jeffersongoncalves/filament-help-desk/compare/2.6.0...2.7.0

## 2.6.0 - 2026-09-21

### What's Changed

* feat: surface company_id ticket scoping for multi-company portals by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-help-desk/pull/101

**Full Changelog**: https://github.com/jeffersongoncalves/filament-help-desk/compare/2.5.0...2.6.0
...
The User panel runs on a satellite application now. Requires `jeffersongoncalves/laravel-help-desk` `^1.9`. Filament v4 — same implementation as 3.4.0.
