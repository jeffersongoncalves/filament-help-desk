...
it('refuses to register the Admin panel on a satellite', function (): void {
    FilamentHelpDeskAdminPlugin::make()->register(Filament::getPanel('user'));
...
it('refuses to register the Operator panel on a satellite', function (): void {
    FilamentHelpDeskOperatorPlugin::make()->register(Filament::getPanel('user'));
...
it('registers the User panel', function (): void {
    ...
    expect(Filament::getPanel('user')->getPlugin(FilamentHelpDeskUserPlugin::make()->getId()))
